...
Na comparação anual, a variação média do Brasil foi de `r (difano_informalRG)*100`% e a maior variação por raça e gênero foi registrada dentre `r max_infanoRG`, uma diferença de VALOR%. Veja mais nos figuras 3 e 4.
