...
# vamos entao editar o formato atual, que esta em "caracter" para um formato data
# Para isso, o R precisa da data num formato AA-MM-DD (ainda que o dia nao importe pra dados triemstrais)
