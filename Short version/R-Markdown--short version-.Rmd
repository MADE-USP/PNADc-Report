...
ggplot(EMPREGO.RG.sh, aes(x=Data, y=Ocupado, color=Categoria)) + 
  ...
  ggtitle("Figura 1: Taxa de Ocupacao por Raça e Gênero") + # plot title
  scale_colour_manual(name = "Regiao", values=c("#FF7276", "#45ff66","#eb52ff", "#3366ff","#feff41", "#8968D3")) + # specifying legend and colors
  theme_bw() + # setting white background
  labs(color = "Categoria") # setting legend title
```
...
ggplot(EMPREGO.REG.sh, aes(x=Data, y=Ocupado, color=Regiao)) + 
  ...
  scale_colour_manual(name = "Regiao", values=c("#FF7276", "#45ff66","#eb52ff", "#3366ff","#feff41", "#8968D3")) + # specifying legend and colors
  theme_bw() + # setting white background
  labs(color = "Regiao") # setting legend title
```
...
#Homem Branco
HB_agro <- trabalhosetor.RG.sh$Agropecuária[trabalhosetor.RG.sh$Categoria == "Homem Branco" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HB_ind <- trabalhosetor.RG.sh$Indústria[trabalhosetor.RG.sh$Categoria == "Homem Branco" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HB_const <- trabalhosetor.RG.sh$Construção[trabalhosetor.RG.sh$Categoria == "Homem Branco" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HB_comercio <- trabalhosetor.RG.sh$Comércio[trabalhosetor.RG.sh$Categoria == "Homem Branco" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HB_tran <- trabalhosetor.RG.sh$Transporte[trabalhosetor.RG.sh$Categoria == "Homem Branco" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HB_alimen <- trabalhosetor.RG.sh$Alimentação[trabalhosetor.RG.sh$Categoria == "Homem Branco" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HB_info <- trabalhosetor.RG.sh$Informação[trabalhosetor.RG.sh$Categoria == "Homem Branco" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HB_publico <- trabalhosetor.RG.sh$Adm_pública[trabalhosetor.RG.sh$Categoria == "Homem Branco" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HB_educa <- trabalhosetor.RG.sh$Educação[trabalhosetor.RG.sh$Categoria == "Homem Branco" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HB_oserv <- trabalhosetor.RG.sh$Outros_serviços[trabalhosetor.RG.sh$Categoria == "Homem Branco" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HB_domes <- trabalhosetor.RG.sh$Ser_domesticos[trabalhosetor.RG.sh$Categoria == "Homem Branco" & trabalhosetor.RG.sh$Data == "2023 Q4"]
...
#Homem negro
HN_agro <- trabalhosetor.RG.sh$Agropecuária[trabalhosetor.RG.sh$Categoria == "Homem Negro" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HN_ind <- trabalhosetor.RG.sh$Indústria[trabalhosetor.RG.sh$Categoria == "Homem Negro" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HN_const <- trabalhosetor.RG.sh$Construção[trabalhosetor.RG.sh$Categoria == "Homem Negro" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HN_comercio <- trabalhosetor.RG.sh$Comércio[trabalhosetor.RG.sh$Categoria == "Homem Negro" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HN_tran <- trabalhosetor.RG.sh$Transporte[trabalhosetor.RG.sh$Categoria == "Homem Negro" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HN_alimen <- trabalhosetor.RG.sh$Alimentação[trabalhosetor.RG.sh$Categoria == "Homem Negro" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HN_info <- trabalhosetor.RG.sh$Informação[trabalhosetor.RG.sh$Categoria == "Homem Negro" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HN_publico <- trabalhosetor.RG.sh$Adm_pública[trabalhosetor.RG.sh$Categoria == "Homem Negro" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HN_educa <- trabalhosetor.RG.sh$Educação[trabalhosetor.RG.sh$Categoria == "Homem Negro" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HN_oserv <- trabalhosetor.RG.sh$Outros_serviços[trabalhosetor.RG.sh$Categoria == "Homem Negro" & trabalhosetor.RG.sh$Data == "2023 Q4"]
HN_domes <- trabalhosetor.RG.sh$Ser_domesticos[trabalhosetor.RG.sh$Categoria == "Homem Negro" & trabalhosetor.RG.sh$Data == "2023 Q4"]
...
#Mulher Branca
MB_agro <- trabalhosetor.RG.sh$Agropecuária[trabalhosetor.RG.sh$Categoria == "Mulher Branca" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MB_const <- trabalhosetor.RG.sh$Construção[trabalhosetor.RG.sh$Categoria == "Mulher Branca" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MB_comercio <- trabalhosetor.RG.sh$Comércio[trabalhosetor.RG.sh$Categoria == "Mulher Branca" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MB_tran <- trabalhosetor.RG.sh$Transporte[trabalhosetor.RG.sh$Categoria == "Mulher Branca" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MB_alimen <- trabalhosetor.RG.sh$Alimentação[trabalhosetor.RG.sh$Categoria == "Mulher Branca" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MB_info <- trabalhosetor.RG.sh$Informação[trabalhosetor.RG.sh$Categoria == "Mulher Branca" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MB_publico <- trabalhosetor.RG.sh$Adm_pública[trabalhosetor.RG.sh$Categoria == "Mulher Branca" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MB_educa <- trabalhosetor.RG.sh$Educação[trabalhosetor.RG.sh$Categoria == "Mulher Branca" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MB_oserv <- trabalhosetor.RG.sh$Outros_serviços[trabalhosetor.RG.sh$Categoria == "Mulher Branca" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MB_domes <- trabalhosetor.RG.sh$Ser_domesticos[trabalhosetor.RG.sh$Categoria == "Mulher Branca" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MB_ind <- trabalhosetor.RG.sh$Indústria[trabalhosetor.RG.sh$Categoria == "Mulher Branca" & trabalhosetor.RG.sh$Data == "2023 Q4"]
...
#Mulher Negra
MN_agro <- trabalhosetor.RG.sh$Agropecuária[trabalhosetor.RG.sh$Categoria == "Mulher Negra" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MN_const <- trabalhosetor.RG.sh$Construção[trabalhosetor.RG.sh$Categoria == "Mulher Negra" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MN_comercio <- trabalhosetor.RG.sh$Comércio[trabalhosetor.RG.sh$Categoria == "Mulher Negra" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MN_tran <- trabalhosetor.RG.sh$Transporte[trabalhosetor.RG.sh$Categoria == "Mulher Negra" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MN_alimen <- trabalhosetor.RG.sh$Alimentação[trabalhosetor.RG.sh$Categoria == "Mulher Negra" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MN_info <- trabalhosetor.RG.sh$Informação[trabalhosetor.RG.sh$Categoria == "Mulher Negra" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MN_publico <- trabalhosetor.RG.sh$Adm_pública[trabalhosetor.RG.sh$Categoria == "Mulher Negra" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MN_educa <- trabalhosetor.RG.sh$Educação[trabalhosetor.RG.sh$Categoria == "Mulher Negra" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MN_oserv <- trabalhosetor.RG.sh$Outros_serviços[trabalhosetor.RG.sh$Categoria == "Mulher Negra" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MN_domes <- trabalhosetor.RG.sh$Ser_domesticos[trabalhosetor.RG.sh$Categoria == "Mulher Negra" & trabalhosetor.RG.sh$Data == "2023 Q4"]
MN_ind <- trabalhosetor.RG.sh$Indústria[trabalhosetor.RG.sh$Categoria == "Mulher Negra" & trabalhosetor.RG.sh$Data == "2023 Q4"]
...
# Raça e gênero
rendahabitHB <- RendaHabit.RG.sh$Renda_Habitual_RG[RendaHabit.RG.sh$Categoria == "Homem Branco" & RendaHabit.RG.sh$Data == "2023 Q4"]
rendahabitHN <- RendaHabit.RG.sh$Renda_Habitual_RG[RendaHabit.RG.sh$Categoria == "Homem Negro" & RendaHabit.RG.sh$Data == "2023 Q4"]
rendahabitMB <- RendaHabit.RG.sh$Renda_Habitual_RG[RendaHabit.RG.sh$Categoria == "Mulher Branca" & RendaHabit.RG.sh$Data == "2023 Q4"]
rendahabitMN <- RendaHabit.RG.sh$Renda_Habitual_RG[RendaHabit.RG.sh$Categoria == "Mulher Negra" & RendaHabit.RG.sh$Data == "2023 Q4"]

##Ano anterior
rendahabitano_HB <- RendaHabit.RG.sh$Renda_Habitual_RG[RendaHabit.RG.sh$Categoria == "Homem Branco" & RendaHabit.RG.sh$Data == "2022 Q4"]
rendahabitano_HN <- RendaHabit.RG.sh$Renda_Habitual_RG[RendaHabit.RG.sh$Categoria == "Homem Negro" & RendaHabit.RG.sh$Data == "2022 Q4"]
rendahabitano_MB <- RendaHabit.RG.sh$Renda_Habitual_RG[RendaHabit.RG.sh$Categoria == "Mulher Branca" & RendaHabit.RG.sh$Data == "2022 Q4"]
rendahabitano_MN <- RendaHabit.RG.sh$Renda_Habitual_RG[RendaHabit.RG.sh$Categoria == "Mulher Negra" & RendaHabit.RG.sh$Data == "2022 Q4"]
...
ggplot(giniRG.sh, aes(x=Data, y=gini, color=Categoria)) + 
  geom_line(size=2) + # defining line thickness
  geom_line(data = giniBR.sh, aes(x = Data, y = gini, color = "Brasil"), linetype = "dashed") + # adding average Gini line
...
giniBR <- giniBR.sh$gini[giniBR.sh$Data == "2023 Q4"]
giniBR_ano_anterior <- giniBR.sh$gini[giniBR.sh$Data == "2022 Q4"]
giniBR_tri_anterior <- giniBR.sh$gini[giniBR.sh$Data == "2023 Q3"]
