...
informalidade <- informalidadeMedia.sh$Taxa_media_informalidade[informalidadeMedia.sh$Data == "2023 Q4"]

informalidade_tri_anterior <- informalidadeMedia.sh$Taxa_media_informalidade[informalidadeMedia.sh$Data == "2023 Q3"]
...
## Ano anterior
informalidade_ano_anterior <- informalidadeMedia.sh$Taxa_media_informalidade[informalidadeMedia.sh$Data == "2022 Q4"]
