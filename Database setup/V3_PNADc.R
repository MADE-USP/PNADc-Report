...
rm (EMPREGO.REG, EMPREGO.RG, EMPREGO.RG.REG, giniBR, giniRG, giniUF, informal.REG, 
    informal.RG, informal.RG.REG, #informalidadeMedia, 
    PEA.REG, PEA.RG, PEA.RG.REG, RendaEfet.RG, RendaEfetivaMedia, RendaHabit.RG, trabalhosetor.REG, trabalhosetor.RG, 
...
# informalidadeMedia is being used in the Markdown file
