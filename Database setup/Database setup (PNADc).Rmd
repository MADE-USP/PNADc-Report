...
save(pnad,file="H:/Meu Drive/Documentos/Made/relatorio_pnad/pnadc_012024.RData")
...
save.image("H:/Meu Drive/Documentos/Made/relatorio_pnad/PNAD_dados_relatorio_01_2024.RData")
```
...
save.image("H:/Meu Drive/Documentos/Made/relatorio_pnad/dados_serie_historica_012024.RData")

#save.image("C:/Users/USER/Documents/PNAD/dados_serie_historica_012024.RData")
```
...
#Transformar em csv
write.csv(quantis_de_renda23_04, "RelatórioPNAD_Dados_Renda_2401.csv")  #Gráfico de perecentis de renda
write.csv(final.RG, file = "RelatorioPNAD_Dados_RG_2401.csv")
write.csv(final.REG, file = "RelatorioPNAD_Dados_REG_2401.csv")
write.csv(final.RG.REG, file = "RelatorioPNAD_Dados_RG_REG_2401.csv")
write.csv(final.outras, file ="RelatorioPNAD_Dados_outras_sh_2401.csv")
```
